...
import { Menu, Package, ShoppingCart, Truck, BarChart3, Settings, LogOut } from "lucide-react"
      ...
      >
        <div className="flex flex-col h-full">
          <div className="p-4 border-b border-gray-700">
            <h2 className="text-xl font-bold text-purple-400">CuraX Pharmacy</h2>
          </div>
      ...
      <div className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
        <div className="flex flex-col flex-grow bg-gray-800 overflow-y-auto">
          <div className="p-6 border-b border-gray-700">
            <h2 className="text-2xl font-bold text-purple-400">CuraX Pharmacy</h2>
          </div>
          <nav className="flex-1 p-4">
            {menuItems.map((item) => (
              <motion.div
        ...
        <div className="bg-gray-800 shadow-lg">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-300">Pharmacy Manager</span>
